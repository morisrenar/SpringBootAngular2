...
@Injectable()
export class AmbulanceServiceService {
  ...
  genericPropertyRouting = "/ambulanceService/";
  ...
  deleteGenericObjects(facility: Facilities, genericPropertyObject: any) {
    ...
    const finalDeleteUrl = this._deleteUrl + "/" + facility.facilitiesId +  this.genericPropertyRouting + genericPropertyObject.facilitiesAmbulanceServiceId;
