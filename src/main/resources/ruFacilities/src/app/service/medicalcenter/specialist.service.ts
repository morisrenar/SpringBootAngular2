...
export class SpecialistService {
  ...
  genericPropertyRouting = "/specialist/";
  ...
  deleteGenericObjects(facility: Facilities, genericPropertyObject: any) {
    ...
    const finalDeleteUrl = this._deleteUrl + "/" + facility.facilitiesId +  this.genericPropertyRouting + genericPropertyObject.medicalCenterSpecialistId;
