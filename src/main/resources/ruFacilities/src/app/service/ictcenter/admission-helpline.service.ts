...
@Injectable()
export class AdmissionHelplineService {
  ...
  genericPropertyRouting = "/admissionHelpline/";
  ...
  deleteGenericObjects(facility: Facilities, genericPropertyObject: any) {
    ...
    const finalDeleteUrl = this._deleteUrl + "/" + facility.facilitiesId +  this.genericPropertyRouting + genericPropertyObject.facilitiesAdmissionHelplineId;
