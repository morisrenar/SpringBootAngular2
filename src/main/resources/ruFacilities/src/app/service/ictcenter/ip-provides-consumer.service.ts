...
@Injectable()
export class IpProvidesConsumerService {
  ...
  genericPropertyRouting = "/idProvidesConsumer/";
  ...
  deleteGenericObjects(facility: Facilities, genericPropertyObject: any) {
    ...
    const finalDeleteUrl = this._deleteUrl + "/" + facility.facilitiesId +  this.genericPropertyRouting + genericPropertyObject.facilitiesIdProvidesConsumersId;
