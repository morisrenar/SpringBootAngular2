...
@Injectable()
export class NetConnectionsLocationService {
  ...
  genericPropertyRouting = "/netConnectionsLocation/";
  ...
  deleteGenericObjects(facility: Facilities, genericPropertyObject: any) {
    ...
    const finalDeleteUrl = this._deleteUrl + "/" + facility.facilitiesId +  this.genericPropertyRouting + genericPropertyObject.facilitiesNetConnectionsLocationId;
