...
@Injectable()
export class TransportationInfoService {
  ...
  genericPropertyRouting = "/transportationInfo/";
  ...
  deleteGenericObjects(facility: Facilities, genericPropertyObject: any) {
    ...
    const finalDeleteUrl = this._deleteUrl + "/" + facility.facilitiesId +  this.genericPropertyRouting + genericPropertyObject.facilitiesTransportationInfoId;
