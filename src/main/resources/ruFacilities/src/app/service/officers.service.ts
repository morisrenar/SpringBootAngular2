...
export class OfficersService {
  ...
  genericPropertyRouting = "/officers/";
  ...
  deleteGenericObjects(facility: Facilities, genericPropertyObject: any) {
    ...
    const finalDeleteUrl = this._deleteUrl + "/" + facility.facilitiesId +  this.genericPropertyRouting + genericPropertyObject.facilitiesOfficersId;
